...
## Building the specific docker-ce

```shell
git clone https://github.com/docker/docker-ce.git
cd docker-ce && git checkout v19.03.15 && cd ..;

make VERSION=19.03.15 PLATFORM=linux/amd64 ENGINE_DIR=./docker-ce/components/engine CLI_DIR=./docker-ce/components/cli centos-9
```
